...
sub _new {
	...
	# デフォルト値を埋める。
		...
		[contenttype => sub {
			...
			require TL::CharConv;
			my $cc = TL::CharConv->_getInstance;
...
=head1 SYNOPSIS
  ...
  $TL->setContentFilter('TL::Filter::TEXT', charset => 'UTF-8');
...
=item contenttype
  ...
  $TL->setContentFilter('TL::Filter::TEXT', contenttype => 'text/plain; charset=sjis');
