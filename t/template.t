...
is(trim $t->getHtml, trim qq{
    <FORM ACTION="" NAME="FORM" EXT="1"><input type="hidden" name="ddd" value="666"><input type="hidden" name="bbb" value="666">
      <INPUT TYPE="text" NAME="aaa" VALUE="333">
    </FORM>
}, 'addHiddenForm (2)');
...
ok($t->node('FORM')->setForm($form->set(aaa => 333), 'FORM'), 'setForm (1)');
